...
@interface RCTCameraManager2 : RCTViewManager<AVCaptureFileOutputRecordingDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property (nonatomic, strong) RCTCamera2 *camera;
